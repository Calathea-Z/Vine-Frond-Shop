...
const HighlightedProductCarousel = () => {
  ...
  return (
    <div className="w-full bg-primary flex flex-col justify-center items-center gap-2 p-4">
      <h1 className='text-2xl sm:text-4xl xl:text-6xl p-4 mb-6'>This Weeks Favorites</h1>
      ...
      {loading ? 
        <ClipLoader color={"#877570"} className='flex justify-center items-center' /> : error ? "Error please reload" 
              : (products.map((product, index) => (
              <div key={index} className='flex justify-center rounded-md p-2 flex-shrink-0 w-[90px] h-auto sm:w-[180px] lg:w-[260px] xl:w-[360px]'>
