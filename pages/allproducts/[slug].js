...
export default function ProductScreen(props) {
  ...
  <div className="w-full h-auto p-4">
    <SingleProductCarousel photo={product.photo} className="w-3/4 mx-auto"/>
  </div>
  <div className="flex flex-col self-center items-start space-y-6 p-2 lg:p-8 grid-col-span-1 lg:grow content-center">
    ...
    {product.countInStock ? (
      <button className="bg-gray-200 border-gray-800 border-[.1rem] rounded px-10 py-2 hover:border-blue-400 mt-4 mb-8" onClick={addToCartHandler}>
        Add to Cart
      </button>
    ) : (
