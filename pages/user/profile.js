		...
		<div>
			...
			<div className="p-4 flex justify-start items-start flex-col h-screen">
				<div className="p-4 flex justify-between w-[98%]">
					...
					<button className="py-3 px-8 text-3xl rounded-md border-2 bg-gray-300 hover:opacity-80">
						Log Out
					</button>
				</div>
				<div>
					...
					<div className="p-5">
						...
						<button className="py-2 px-4 text-lg rounded-md border-2 bg-gray-300 hover:opacity-80">
