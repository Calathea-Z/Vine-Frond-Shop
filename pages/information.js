				...
				<div>
					...
					>
						<div className="p-2 flex justify-between items-center">
							<h1 className="mb-4 text-md font-sans font-bold">Contact</h1>
							{loggedIn ? (
								<h1 className="text-xs sm:text-sm text-purple-400">
									Thanks for your support, {userInfo.firstName} !
								</h1>
							) : (
						...
						<div className="mb-2 relative">
							...
							<input
								className={`w-full p-4 leading-0 font-sans rounded-md border-2 focus:bg-transparent focus:ring-0 ${
							...
							/>
							{errors.shippingContactEmail && (
								<div className="absolute inset-y-0 bottom-8 right-4 flex items-center">
									<ExclamationCircleIcon className="h-5 w-5 text-red-500" />
								</div>
							)}
							{errors.shippingContactEmail && (
								<div className="text-red-500 p-2 text-xs font-thin">
