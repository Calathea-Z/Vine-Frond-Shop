	...
	return (
		<div>
			<div className="p-10 flex flex-col">
				...
				<button
					className="rounded-md w-full h-auto border-2 border-gray-300 p-4 bg-primary hover:bg-primary/80 font-sans flex justify-center items-center mb-4 shadow-md"
